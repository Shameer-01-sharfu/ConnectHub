...
# Reads from the SECRET_KEY env var in production; falls back to the
# insecure dev key only when that var isn't set (local development).
SECRET_KEY = os.environ.get(
    "SECRET_KEY",
    "django-insecure-=9_6bzyb5)r*a-g0w!xq8x=nkc16__=c11zy0p1vwn%-zkgcbk",
)
...
# because Render's/most PaaS disks are ephemeral - files saved locally
# get wiped on every redeploy/restart.
CLOUDINARY_STORAGE = {
